...
#pragma comment(lib, "Cesium3DTilesSelection.lib")
#pragma comment(lib, "Cesium3DTilesReader.lib")
#pragma comment(lib, "Cesium3DTilesWriter.lib")
#pragma comment(lib, "CesiumAsync.lib")
#pragma comment(lib, "CesiumGeometry.lib")
#pragma comment(lib, "CesiumGeospatial.lib")
#pragma comment(lib, "CesiumGltf.lib")
#pragma comment(lib, "CesiumGltfContent.lib")
#pragma comment(lib, "CesiumGltfReader.lib")
#pragma comment(lib, "CesiumIonClient.lib")
#pragma comment(lib, "CesiumGltfWriter.lib")
#pragma comment(lib, "CesiumJsonReader.lib")
#pragma comment(lib, "CesiumJsonWriter.lib")
#pragma comment(lib, "CesiumUtility.lib")
#pragma comment(lib, "CesiumQuantizedMeshTerrain.lib")
#pragma comment(lib, "CesiumRasterOverlays.lib")
#pragma comment(lib, "async++.lib")
#pragma comment(lib, "glm.lib")
#pragma comment(lib, "meshoptimizer.lib")
#pragma comment(lib, "fmt.lib")
#pragma comment(lib, "draco.lib")
#pragma comment(lib, "uriparser.lib")
#pragma comment(lib, "s2.lib")
#pragma comment(lib, "ktx.lib")
#pragma comment(lib, "jpeg.lib")
#pragma comment(lib, "libcrypto.lib")
#pragma comment(lib, "libmodpbase64.lib")
